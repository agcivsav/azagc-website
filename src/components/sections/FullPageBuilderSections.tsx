...
export type FullPageBuilderContext = {
  ...
  articles: Array<{ headline: string; slug: string; publishedAt: string | null; excerpt: string | null }>
  events: Array<{ title: string; slug: string; startDate: string; category: string | null }>
  filtered: Array<{ title: string; slug: string; startDate: string; category: string | null }>
  categories: string[]
...
export default function FullPageBuilderSections({ sections, context }: FullPageBuilderSectionsProps) {
  const {
    buildImageUrl,
    defaultTitle,
    defaultSubtitle,
