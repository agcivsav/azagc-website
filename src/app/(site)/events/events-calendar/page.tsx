...
type EventItem = { title: string; slug: string; startDate: string; category: string | null }
    ...
    <>
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span>
          <a href="/events" className="hover:text-navy transition-colors no-underline">Events</a>
          <span>/</span>
          <Link href="/events/events-calendar" className="hover:text-navy transition-colors no-underline">Events Calendar</Link>
        </div>
      </div>
        ...
        <>
          <section className="bg-navy py-16">
            <div className="container-site">
              <h1 className="font-normal text-4xl md:text-5xl text-white">Events Calendar</h1>
