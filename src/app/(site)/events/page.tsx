...
export const metadata: Metadata = {
  title: 'Events',
  description: 'Upcoming AZAGC events — conferences, workshops, networking, and industry shows in Arizona.',
}
    ...
    <>
      ...
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span><a href="/events" className="hover:text-navy transition-colors no-underline">Events</a>
        </div>
      </div>
      ...
      <section className="bg-navy py-16">
        <div className="container-site">
          ...
          <SectionTitle as="h1" className="text-white">Events</SectionTitle>
          <p className="font-body text-white/60 mt-3 max-w-2xl text-base">
            {/* TODO: Pull from Sanity siteSettings or page.heroSubtitle */}
            Upcoming AZAGC events — conferences, workshops, networking, and industry shows in Arizona.
          </p>
        </div>
      </section>
