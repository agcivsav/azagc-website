    ...
    <>
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span>
          <a href="/education-training/agc-of-america-education" className="hover:text-navy transition-colors no-underline">
          ...
          <section className="bg-cream py-16">
            <div className="container-site max-w-2xl text-center">
              <p className="font-body text-slate">
                Add sections in Sanity Studio (AGC of America Education Page) to build this page.
              </p>
            </div>
          </section>
        </>
