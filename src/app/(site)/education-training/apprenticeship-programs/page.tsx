...
export const metadata: Metadata = {
  ...
  description: 'AZAGC apprenticeship programs develop skilled workers for Arizona&apos;s agricultural contracting industry.',
}
    ...
    <>
      ...
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span><a href="/education-training" className="hover:text-navy transition-colors no-underline">Education Training</a> <span>/</span><a href="/education-training/apprenticeship-programs" className="hover:text-navy transition-colors no-underline">Apprenticeship Programs</a>
        </div>
      </div>
      ...
      <section className="bg-navy py-16">
        <div className="container-site">
          ...
          <SectionTitle as="h1" className="text-white">Apprenticeship Programs</SectionTitle>
          <p className="font-body text-white/60 mt-3 max-w-2xl text-base">
            {/* TODO: Pull from Sanity siteSettings or page.heroSubtitle */}
            AZAGC apprenticeship programs develop skilled workers for Arizona's agricultural contracting industry.
          </p>
        </div>
      </section>
