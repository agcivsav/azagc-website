...
export const metadata: Metadata = {
  ...
  description: 'Student resources and scholarship opportunities through AZAGC for Arizona agricultural education students.',
}
    ...
    <>
      ...
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span><a href="/education-training" className="hover:text-navy transition-colors no-underline">Education Training</a> <span>/</span><a href="/education-training/student-resources" className="hover:text-navy transition-colors no-underline">Student Resources</a>
        </div>
      </div>
      ...
      <section className="bg-navy py-16">
        <div className="container-site">
          ...
          <SectionTitle as="h1" className="text-white">Student Resources</SectionTitle>
          <p className="font-body text-white/60 mt-3 max-w-2xl text-base">
            {/* TODO: Pull from Sanity siteSettings or page.heroSubtitle */}
            Student resources and scholarship opportunities through AZAGC for Arizona agricultural education students.
          </p>
        </div>
      </section>
