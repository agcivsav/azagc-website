...
export const metadata: Metadata = {
  ...
  description: 'AZAGC accessibility statement and our commitment to digital inclusion.',
}
    ...
    <>
      ...
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span><a href="/accessibility-statement" className="hover:text-navy transition-colors no-underline">Accessibility Statement</a>
        </div>
      </div>
      ...
      <section className="bg-navy py-16">
        <div className="container-site">
          ...
          <SectionTitle as="h1" className="text-white">Accessibility Statement</SectionTitle>
