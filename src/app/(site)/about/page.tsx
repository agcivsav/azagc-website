...
export const metadata: Metadata = {
  title: 'About AZAGC',
  description: 'Learn about the Arizona Agribusiness & Equine Center, our mission, history, and the industries we serve.',
}
    ...
    <>
      ...
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span><a href="/about" className="hover:text-navy transition-colors no-underline">About</a>
        </div>
      </div>
      ...
      <section className="bg-navy py-16">
        <div className="container-site">
          ...
          <SectionTitle as="h1" className="text-white">About AZAGC</SectionTitle>
          <p className="font-body text-white/60 mt-3 max-w-2xl text-base">
            {/* TODO: Pull from Sanity siteSettings or page.heroSubtitle */}
            Learn about the Arizona Agribusiness & Equine Center, our mission, history, and the industries we serve.
          </p>
        </div>
      </section>
