    ...
    <>
      <section className="bg-navy py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="font-body text-lg text-white/75 max-w-2xl">
            Arizona&apos;s oldest construction association, founded in 1934. For
            90+ years, AZAGC has been the voice of Arizona contractors —
            advocating, educating, and building community.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto space-y-10">
          <div>
            ...
            <p className="font-body text-base text-slate leading-relaxed">
              AZAGC was founded in 1934 as the Arizona Chapter of the Associated
              General Contractors of America — part of the national AGC network
              established in 1918. For over 90 years, AZAGC has represented
              Arizona contractors through economic booms and downturns,
              legislative battles and infrastructure surges. We have been here
              for every chapter of Arizona&apos;s built environment.
            </p>
          </div>
          <div>
            <h2 className="font-normal text-2xl text-navy mb-3">Our Mission</h2>
            <p className="font-body text-base text-slate leading-relaxed">
              AZAGC&apos;s mission is to support the construction industry
              through advocacy, education, and building community. We exist to
              give Arizona contractors a unified voice in the political process,
              develop the workforce the industry needs, and create the
              relationships that make Arizona construction a community — not
              just a market.
            </p>
          </div>
          <div>
            ...
            <p className="font-body text-base text-slate leading-relaxed">
              AZAGC represents 500+ member companies responsible for over $1
              billion in annual construction volume across Arizona. Our members
              build the infrastructure, commercial facilities, and public works
              that make Arizona function. Our apprenticeship programs have
              trained thousands of Arizona tradespeople. Our advocacy has
              produced hundreds of legislative wins.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-xl bg-navy p-7 mx-auto">
          <LeadForm
            source="about-page"
            headline="Questions? Talk to Our Team."
...
export default async function AboutPage({
  ...
  const articles = Array.isArray(newsList)
    ? newsList.filter((a) => a?.slug)
    : [];
  ...
  const defaultSubtitle =
    "Arizona's oldest construction association, founded in 1934. For 90+ years, AZAGC has been the voice of Arizona contractors.";
