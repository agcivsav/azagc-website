...
export default async function AwardsProgramPage({
  ...
  const defaultSubtitle =
    "Our annual chapter awards program recognizes companies and individuals for excellence in construction, safety, leadership and dedication to the association and the industry.";
          ...
          <section className="bg-cream py-16">
            <div className="container-site max-w-2xl text-center">
              <p className="font-body text-slate">
                Add sections in Sanity Studio (Awards Program Page) to build
                this page. Use the &quot;Tab Section&quot; for award categories.
              </p>
            </div>
          </section>
        </>
