...
export const metadata: Metadata = {
  ...
  description: 'AZAGC recognizes excellence in Arizona agribusiness. Nominate a deserving company or individual.',
}
    ...
    <>
      ...
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span><a href="/about" className="hover:text-navy transition-colors no-underline">About</a> <span>/</span><a href="/about/awards-program" className="hover:text-navy transition-colors no-underline">Awards Program</a>
        </div>
      </div>
      ...
      <section className="bg-navy py-16">
        <div className="container-site">
          ...
          <SectionTitle as="h1" className="text-white">Awards Program</SectionTitle>
          <p className="font-body text-white/60 mt-3 max-w-2xl text-base">
            {/* TODO: Pull from Sanity siteSettings or page.heroSubtitle */}
            AZAGC recognizes excellence in Arizona agribusiness. Nominate a deserving company or individual.
          </p>
        </div>
      </section>
