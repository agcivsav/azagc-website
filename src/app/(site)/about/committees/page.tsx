...
export const metadata: Metadata = {
  title: 'Committees',
  description: 'AZAGC committees drive policy, workforce, and industry initiatives. Learn how to get involved.',
}
    ...
    <>
      ...
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span><a href="/about" className="hover:text-navy transition-colors no-underline">About</a> <span>/</span><a href="/about/committees" className="hover:text-navy transition-colors no-underline">Committees</a>
        </div>
      </div>
      ...
      <section className="bg-navy py-16">
        <div className="container-site">
          ...
          <SectionTitle as="h1" className="text-white">Committees</SectionTitle>
