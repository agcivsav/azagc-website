...
export const metadata: Metadata = {
  title: 'Advocacy',
  description: 'AZAGC advocates for Arizona&apos;s agricultural industry at the state capitol and in Washington, D.C.',
}
    ...
    <>
      ...
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span><a href="/advocacy" className="hover:text-navy transition-colors no-underline">Advocacy</a>
        </div>
      </div>
      ...
      <section className="bg-navy py-16">
        <div className="container-site">
          ...
          <SectionTitle as="h1" className="text-white">Advocacy</SectionTitle>
          <p className="font-body text-white/60 mt-3 max-w-2xl text-base">
            {/* TODO: Pull from Sanity siteSettings or page.heroSubtitle */}
            AZAGC advocates for Arizona's agricultural industry at the state capitol and in Washington, D.C.
          </p>
        </div>
      </section>
