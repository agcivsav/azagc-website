...
export const metadata: Metadata = {
  ...
  description: 'AZAGC&apos;s legislative priorities for Arizona agribusiness — infrastructure, workforce, environment, and more.',
}
    ...
    <>
      ...
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span><a href="/advocacy" className="hover:text-navy transition-colors no-underline">Advocacy</a> <span>/</span><a href="/advocacy/policy-priorities" className="hover:text-navy transition-colors no-underline">Policy Priorities</a>
        </div>
      </div>
      ...
      <section className="bg-navy py-16">
        <div className="container-site">
          ...
          <SectionTitle as="h1" className="text-white">Policy Priorities</SectionTitle>
          <p className="font-body text-white/60 mt-3 max-w-2xl text-base">
            {/* TODO: Pull from Sanity siteSettings or page.heroSubtitle */}
            AZAGC's legislative priorities for Arizona agribusiness — infrastructure, workforce, environment, and more.
          </p>
        </div>
      </section>
