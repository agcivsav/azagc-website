...
export const metadata: Metadata = {
  ...
  description: 'Join Arizona&apos;s premier agricultural association. Contractor and affiliate memberships available.',
}
    ...
    <>
      ...
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span><a href="/membership" className="hover:text-navy transition-colors no-underline">Membership</a>
        </div>
      </div>
      ...
      <section className="bg-navy py-16">
        <div className="container-site">
          ...
          <SectionTitle as="h1" className="text-white">Membership Overview</SectionTitle>
          <p className="font-body text-white/60 mt-3 max-w-2xl text-base">
            {/* TODO: Pull from Sanity siteSettings or page.heroSubtitle */}
            Join Arizona's premier agricultural association. Contractor and affiliate memberships available.
          </p>
        </div>
      </section>
      ...
      <CTABand />
      <BottomCTA source="membership-overview" />
    </>
  )
}
