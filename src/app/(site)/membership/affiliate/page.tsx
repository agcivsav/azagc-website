...
export const metadata: Metadata = {
  ...
  description: 'Affiliate membership connects suppliers, lenders, and service providers with Arizona&apos;s top agricultural contractors.',
}
    ...
    <>
      ...
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span><a href="/membership" className="hover:text-navy transition-colors no-underline">Membership</a> <span>/</span><a href="/membership/affiliate" className="hover:text-navy transition-colors no-underline">Affiliate</a>
        </div>
      </div>
      ...
      <section className="bg-navy py-16">
        <div className="container-site">
          ...
          <SectionTitle as="h1" className="text-white">Affiliate Membership</SectionTitle>
          <p className="font-body text-white/60 mt-3 max-w-2xl text-base">
            {/* TODO: Pull from Sanity siteSettings or page.heroSubtitle */}
            Affiliate membership connects suppliers, lenders, and service providers with Arizona's top agricultural contractors.
          </p>
        </div>
      </section>
      ...
      <CTABand />
      <BottomCTA source="affiliate-page" />
    </>
  )
}
