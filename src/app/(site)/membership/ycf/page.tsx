...
export const metadata: Metadata = {
  title: 'Young Contractor Forum',
  description: 'AZAGC&apos;s Young Contractor Forum develops the next generation of Arizona agribusiness leaders.',
}
    ...
    <>
      ...
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span><a href="/membership" className="hover:text-navy transition-colors no-underline">Membership</a> <span>/</span><a href="/membership/ycf" className="hover:text-navy transition-colors no-underline">Ycf</a>
        </div>
      </div>
      ...
      <section className="bg-navy py-16">
        <div className="container-site">
          ...
          <SectionTitle as="h1" className="text-white">Young Contractor Forum</SectionTitle>
          <p className="font-body text-white/60 mt-3 max-w-2xl text-base">
            {/* TODO: Pull from Sanity siteSettings or page.heroSubtitle */}
            AZAGC's Young Contractor Forum develops the next generation of Arizona agribusiness leaders.
          </p>
        </div>
      </section>
