...
export const metadata: Metadata = {
  title: 'Safety',
  description: 'Safety training, resources, and compliance guidance for Arizona contractors.',
}

const PAGE_QUERY = `*[_type == "safetyPage"][0]{ ${INDUSTRY_RESOURCES_PAGE_QUERY_FRAGMENT} }`
    ...
    <>
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span>
          <a href="/industry-resources/safety" className="hover:text-navy transition-colors no-underline">
            Safety
          </a>
        </div>
      </div>
          ...
          <section className="bg-cream py-16">
            <div className="container-site max-w-2xl text-center">
              <p className="font-body text-slate">
                Add sections in Sanity Studio (Safety Page) to build this page.
              </p>
            </div>
          </section>
        </>
