    ...
    <>
      ...
      <div className="bg-white border-b border-warm-gray">
        <div className="container-site py-3 flex items-center gap-2 text-xs font-body text-slate">
          ...
          <span>/</span><a href="/industry-resources" className="hover:text-navy transition-colors no-underline">Industry Resources</a> <span>/</span><a href="/industry-resources/transportation-infrastructure" className="hover:text-navy transition-colors no-underline">Transportation Infrastructure</a>
        </div>
      </div>
      ...
      <section className="bg-navy py-16">
        <div className="container-site">
          ...
          <SectionTitle as="h1" className="text-white">Transportation & Infrastructure</SectionTitle>
          <p className="font-body text-white/60 mt-3 max-w-2xl text-base">
            {/* TODO: Pull from Sanity siteSettings or page.heroSubtitle */}
            AZAGC resources on transportation and infrastructure policy for Arizona contractors.
          </p>
        </div>
      </section>
